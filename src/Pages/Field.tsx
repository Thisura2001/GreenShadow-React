...
export default function Field(){
    return(
        <>
            <section id="field">
                <h2 className="field-title">Field Management... </h2>
                <div className="d-flex justify-content-end mb-3">
                    <button className="bg-blue-500 text-white rounded-3" id="addFieldBtn">Add New Field</button>
                </div>
                <div className="card mt-3" id="fieldFormCard" style={{ display: 'none' }}>
                    <div className="card-header">
                        <h4>Add Field Details</h4>
                        <button className="btn-close" id="closeFieldForm" onClick="closeFiledForm()"></button>
                    </div>
                ...
                <div id="updateFieldModal" className="modal" style={{ display: 'none' }}>
                    <div className="modal-overlay" onClick="closeUpdateModal()">X</div>
