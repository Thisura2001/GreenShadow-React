...
export default function FieldForm() {
    ...
    const [fieldImg1, setFieldImg1] = useState<File | null>(null);
    const [fieldImg2, setFieldImg2] = useState<File | null>(null);

    const dispatch = useDispatch<AppDispatch>();

    const handleImageChange1 = (e) => {
        setFieldImg1(e.target.files[0]);
    }

    const handleImageChange2 = (e) => {
        setFieldImg2(e.target.files[0]);
    }
